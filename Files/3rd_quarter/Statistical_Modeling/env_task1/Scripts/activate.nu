...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\diego\OneDrive\Diego Monroy\UPY\UPY_exercises\3rd_quarter\Statistical_Modeling\env'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\diego\OneDrive\Diego Monroy\UPY\UPY_exercises\3rd_quarter\Statistical_Modeling\env\Scripts\deactivate.nu'
